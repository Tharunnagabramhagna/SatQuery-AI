...
export const MOCK_ANALYSIS_HISTORY: AnalysisRecord[] = [
  ...
  // ─── Optical + SAR ─────────────────────────────────────────────
  {
    ...
    isDemo: true,
    resultSummary: 'Optical image reveals land-cover distribution. SAR view provides complementary structural visualization.',
    confidence: 78,
    thumbnail: '/imagery/sat_after.jpg',
    evidenceCount: 2,
  ...
  },
  {
    ...
    modality: 'Optical + SAR',
    isDemo: true,
    resultSummary: 'Multimodal observation comparing optical RGB and SAR visual treatment for terrain features.',
    confidence: 75,
    thumbnail: '/imagery/sat_after.jpg',
    evidenceCount: 2,
    imageryType: 'optical_sar',
