...
export function WorkspaceSecondarySidebar({
  ...
  return (
    <aside className="w-52 lg:w-56 border-r border-slate-200 dark:border-slate-800/80 bg-slate-50/60 dark:bg-[#080d1a] flex flex-col py-3 px-2 shrink-0 select-none overflow-y-auto">
      {/* Header Pill */}
      ...
      <div className="space-y-1">
        <div className="px-2 text-[10px] font-semibold text-slate-400 dark:text-slate-400 uppercase tracking-wider mb-1.5">
          Analysis Modes
        </div>
        ...
        {WORKSPACE_MODES.map((mode) => {
          ...
          return (
            <button
              ...
              className={cn(
                'w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-xs font-medium transition-all duration-150 text-left',
                isActive
